  ...
  <div class="o-wrapper">
    ...
    <div class="hero-hero-outer">
      ...
      <div class="hh-icon hh-icon--left u-margin-right-small">
           <div class="sliderOnemanages">    
                <div class="baner_move"> 
                    <img class="mySlides" src="<?php echo get_template_directory_uri(); ?>/assets/img/baner1.svg">
                    <img class="mySlides" src="<?php echo get_template_directory_uri(); ?>/assets/img/baner2.svg">
                    <img class="mySlides" src="<?php echo get_template_directory_uri(); ?>/assets/img/baner3.svg">
                    <img class="mySlides" src="<?php echo get_template_directory_uri(); ?>/assets/img/baner4.svg">
                    <img class="mySlides" src="<?php echo get_template_directory_uri(); ?>/assets/img/baner5.svg">
                </div> 
            </div>
        </div> 
      ...
      <div class="hh-icon hh-icon--right u-margin-left-small"> 
          <div class="sliderOnemanages">   
                <div class="baner_move">
                    <img class="mySlidestwo" src="<?php echo get_template_directory_uri(); ?>/assets/img/2banner2.svg">
                    <img class="mySlidestwo" src="<?php echo get_template_directory_uri(); ?>/assets/img/2banner3.svg">
                    <img class="mySlidestwo" src="<?php echo get_template_directory_uri(); ?>/assets/img/2banner4.svg">
                    <img class="mySlidestwo" src="<?php echo get_template_directory_uri(); ?>/assets/img/2banner5.svg">
                    <img class="mySlidestwo" src="<?php echo get_template_directory_uri(); ?>/assets/img/2banner6.svg">  
                </div> 
            </div>      
      </div>
