...
section.home-hero a#get-started-homepage:hover { 
    background-color: #ed4075;
            ...
            #carouselExampleIndicators .carousel-fade .carousel-item-next.carousel-item-left,
            #carouselExampleIndicators .carousel-fade .carousel-item-prev.carousel-item-right {
                opacity: 1;
            }

            #carouselExampleIndicators .carousel-fade .active.carousel-item-left,
            #carouselExampleIndicators .carousel-fade .active.carousel-item-right {
                opacity: 0;
            }

            #carouselExampleIndicators .carousel-fade .carousel-item-next,
            #carouselExampleIndicators .carousel-fade .carousel-item-prev,
            #carouselExampleIndicators .carousel-fade .carousel-item.active,
            #carouselExampleIndicators .carousel-fade .active.carousel-item-left,
            #carouselExampleIndicators .carousel-fade .active.carousel-item-prev {
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-9 col-sm-8 col-4">
                            ...
                            <div class="main-menu d-flex align-items-center justify-content-end">
                                ...
                                'header', 'menu_class' => 'nav align-items-center', 'container' => '')); ?>
                            </div>
