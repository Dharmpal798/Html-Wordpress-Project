...
<section class="banner section-pattern d-none" data-bg-img="<?php echo get_template_directory_uri(); ?>/assets/img/section-pattern/slider-pattern.png">
    ...
    <div class="banner-slider owl-carousel d-flex align-items-center justify-content-center" data-owl-animate-in="fadeIn" data-owl-animate-Out="fadeOut" data-owl-autoplay="true" data-owl-dots="true" data-pause="true" data-interval="1000">
        ...
        'banner', 'posts_per_page' => 3) ); if ( $loop->have_posts() ) : while ( $loop->have_posts() ) : $loop->the_post(); ?>
        ...
        <div class="hero-hero-outer">
                ...
                <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel" data-interval="4000">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/assets/img/baner1.svg" />
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/assets/img/baner2.svg" />
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/assets/img/baner3.svg" />
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/assets/img/baner4.svg" />
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/assets/img/baner5.svg" />
                        </div>
                    </div>
                </div>
            ...
            <div class="home-hero-max-width">
                <div class="home-hero__searchbar">
                    <section class="hero-search">
                        ...
                        <figure>
                            <div class="figure_changes">
                                <div class="row">
                                    <div class="mySlidesthree"><span>9,900</span></div>
                                    <!-- <div class="mySlidesthree"><span>15,000</span></div>
                        <div class="mySlidesthree"><span>12,100</span></div>
                        <div class="mySlidesthree"><span>27,000</span></div>
                        <div class="mySlidesthree"><span>4,000</div> --> 
                                    <div class="txt_search">Searches/Month</div>
                                </div>
                            </div>
                        </figure>
                    </section>
                ...
                <div class="text--center hp-button-container">
                    <a href="#" id="get-started-homepage" class="c-btn c-btn--accent">Request Demo</a>
                </div>
            </div>
            ...
            <div class="hh-icon hh-icon--right u-margin-left-small">
                <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel" data-interval="4000">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/assets/img/2banner2.svg" />
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/assets/img/2banner3.svg" />
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/assets/img/2banner4.svg" />
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/assets/img/2banner5.svg" />
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo get_template_directory_uri(); ?>/assets/img/2banner6.svg" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-12">
                    ...
                    <div class="modal-content">
                        ...
                        <?php echo do_shortcode('[contact-form-7 id="178" title="Home"]'); ?>
            ...
            <div class="col-12">
                <div class="brand-logo owl-carousel" data-owl-items="6" data-owl-autoplay="false" data-owl-responsive='{"0": {"items": "2"},"575":{"items": "3"},"768": {"items": "4"},"992": {"items": "6"}}'>
                    <?php
                                    ...
                                    $loop = new WP_Query( array( 'post_type' =>
                    'sponsor') ); if ( $loop->have_posts() ) : while ( $loop->have_posts() ) : $loop->the_post(); ?>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <?php
                                    ...
                                    $loop = new WP_Query( array( 'post_type' =>
            'feature', 'posts_per_page' => 3) ); if ( $loop->have_posts() ) : while ( $loop->have_posts() ) : $loop->the_post(); ?>
...
<section class="pt-120 pb-120 section-pattern" data-bg-img="<?php echo get_template_directory_uri(); ?>/assets/img/section-pattern/service-pattern.png">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div class="section-title">
                    ...
                    <p>We highest ye friends is exposed equally in. Ignorant had too strictly followed. Astonished as travelling assistance or unreserved oh pianoforte ye.</p>
                </div>
    ...
    $loop = new WP_Query( array('post_parent' =>
                    '9', 'post_type' => 'page', 'posts_per_page' => 4 ) ); if ( $loop->have_posts() ) : while ( $loop->have_posts() ) : $loop->the_post(); ?>
    ...
    <div class="container">
        ...
        <div class="row process-bg" data-bg-img="<?php echo get_template_directory_uri(); ?>/assets/img/process_shape.png">
            <?php
                                    ...
                                    $loop = new WP_Query( array( 'post_type' =>
            'process', 'posts_per_page' => 4) ); if ( $loop->have_posts() ) : while ( $loop->have_posts() ) : $loop->the_post(); ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <div class="section-title text-center">
                    ...
                    <p>Mutual has cannot beauty indeed now sussex merely you. It possible no husbands jennings ye offended packages pleasant he. Remainder recommend who applauded departure joy.</p>
                </div>
        ...
        <div class="row project-items grid">
            <?php
                                    ...
                                    $loop = new WP_Query( array( 'post_type' =>
            'project', 'posts_per_page' =>4) ); if ( $loop->have_posts() ) : while ( $loop->have_posts() ) : $loop->the_post(); ?>
                ...
                <div class="single-project-item">
                    ...
                    <div class="project-body">
                        ...
                        <p class="project-meta">
                            Client:<span><?php echo get_field('client'); ?></span>
                        </p>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="cta-content text-center text-white">
                    <h2>
                        The best strategical business <br />

                        agency to build up your business in next level.
                    </h2>

                    <p>Distrusts fulfilled happiness unwilling as explained of difficult. No landlord of peculiar ladyship attended if contempt ecstatic. Loud wish made on is am as hard. Court so avoid in plate hence.</p>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="blog-slider owl-carousel custom-owl dots-horizontal" data-owl-items="2" data-owl-margin="30" data-owl-dots="true" data-owl-responsive='{"0": {"items": "1"},"992": {"items": "2"}}'>
                    ...
                    <?php
                                      ...
                                      $curr = get_the_ID();
                                        ...
                                        $loop = new WP_Query( array( 'post_type' =>
                    'blogs', 'posts_per_page' => 4, 'orderby' => 'rand', 'post__not_in' => array($curr) ) ); if ( $loop->have_posts() ) : while ( $loop->have_posts() ) : $loop->the_post(); ?>
               ...
               $category = get_the_category( $post->ID ); echo $category[0]->cat_name;?>
                            </p>
    ...
    <div class="container">
        ...
        <div class="testimonial-slider owl-carousel" data-owl-nav="true" data-owl-autoplay="false" data-owl-animate-Out="fadeOut" data-owl-animate-in="fadeIn" data-owl-margin="3">
            ...
            <?php
                                    ...
                                    $loop = new WP_Query( array( 'post_type' =>
            'testimonial') ); if ( $loop->have_posts() ) : while ( $loop->have_posts() ) : $loop->the_post(); ?>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 col-12">
                        ...
                        <div class="testimonial-content">
                            ...
                            <h4>
                                <?php echo the_title(); ?>
                                <span><?php echo get_field('testimonial_positions')?></span>
                            </h4>
                        </div>
