...
<?php echo do_shortcode('[contact-form-7 id="229" title="Analyze Form"]'); ?>
    ...
    <section class="pt-120 pb-120 section-pattern" data-bg-img="<?php echo get_template_directory_uri(); ?>/assets/img/section-pattern/testimonial-pattern.png"> 
